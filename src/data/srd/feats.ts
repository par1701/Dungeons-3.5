...
export const SRD_FEATS: Feat[] = [
  ...
  // ---------------------------------------------------------------------
  {
    ...
    skillBonuses: [
      { skillId: "jump", bonus: 2 },
      { skillId: "tumble", bonus: 2 },
    ],
    prerequisites: [],
  ...
  },
  {
    ...
    skillBonuses: [
      { skillId: "balance", bonus: 2 },
      { skillId: "escape-artist", bonus: 2 },
    ],
    prerequisites: [],
    fighterBonusFeat: false,
    stackable: false,
  },
  {
    ...
    skillBonuses: [
      { skillId: "listen", bonus: 2 },
      { skillId: "spot", bonus: 2 },
    ],
    prerequisites: [],
    fighterBonusFeat: false,
    stackable: false,
  },
  {
    ...
    skillBonuses: [
      { skillId: "handle-animal", bonus: 2 },
      { skillId: "ride", bonus: 2 },
    ],
    prerequisites: [],
    fighterBonusFeat: false,
    stackable: false,
  },
  {
    ...
    skillBonuses: [
      { skillId: "climb", bonus: 2 },
      { skillId: "swim", bonus: 2 },
    ],
    prerequisites: [],
    fighterBonusFeat: false,
    stackable: false,
  ...
  },
  {
    ...
    skillBonuses: [
      { skillId: "disguise", bonus: 2 },
      { skillId: "forgery", bonus: 2 },
    ],
    prerequisites: [],
    fighterBonusFeat: false,
    stackable: false,
  },
  {
    ...
    skillBonuses: [
      { skillId: "sleight-of-hand", bonus: 2 },
      { skillId: "use-rope", bonus: 2 },
    ],
    prerequisites: [],
    fighterBonusFeat: false,
    stackable: false,
  },
  {
    ...
    skillBonuses: [
      { skillId: "appraise", bonus: 2 },
      { skillId: "decipher-script", bonus: 2 },
    ],
    prerequisites: [],
    fighterBonusFeat: false,
    stackable: false,
  ...
  },
  {
    ...
    skillBonuses: [
      { skillId: "spellcraft", bonus: 2 },
      { skillId: "use-magic-device", bonus: 2 },
    ],
    prerequisites: [],
    fighterBonusFeat: false,
    stackable: false,
  ...
  },
  {
    ...
    skillBonuses: [
      { skillId: "hide", bonus: 2 },
      { skillId: "move-silently", bonus: 2 },
    ],
    prerequisites: [],
    fighterBonusFeat: false,
    stackable: false,
