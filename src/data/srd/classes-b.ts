...
const bardFeatures: ClassFeature[] = [
  ...
  { level: 12, name: "Canción de libertad", description: "Un bardo de nivel 12 o superior con 15 o más rangos en una habilidad de Interpretar puede usar su música o poesía para crear un efecto equivalente al conjuro liberar de maldición (nivel de lanzador igual a su nivel de bardo). Requiere 1 minuto de concentración e interpretación ininterrumpidas y afecta a un único objetivo a 9 m (30 pies) o menos. El bardo no puede usar esta habilidad sobre sí mismo." },
