...
export const SRD_WEAPON_PROPERTIES: MagicItemProperty[] = [
  ...
  { id: "speed", name: "de Velocidad", source: "srd", appliesTo: "arma", bonusEquivalent: 3, minEnhancementBonus: 1, description: "El portador gana un ataque cuerpo a cuerpo adicional a su bonificador de ataque más alto cada vez que realiza una acción de ataque completo (como Acelerar, pero solo para ataques con esta arma)." },
